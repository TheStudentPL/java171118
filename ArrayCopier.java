public class ArrayCopier {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("]");
        System.out.println("Number of object: " + arrayIn.length );

        System.out.print("arrayOut: [ ");
        int counter = 0;
        while(counter < arrayIn.length && arrayIn[counter] != 1){
            arrayOut[counter] = (double)arrayIn[counter]; // niejawna konwersja typow
            System.out.print(arrayOut[counter++] + "  ");
        }
        System.out.println("]");
        System.out.println("Number of object: " + arrayOut.length );
    }
}
